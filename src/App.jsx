...
<button className="fixed bottom-6 right-6 bg-gradient-to-r from-blue-600 to-green-500 text-white p-4 rounded-full shadow-xl hover:scale-110 transition-transform duration-300">
