  ...
  async function submit(e) {
    ...
    try {
      ...
      if (res.data?.success) {
        ...
        // we received safeUser; token cookie stored by browser (httpOnly)
        const user = res.data.user || {};
        // navigate to sales dashboard
        navigate(`/admin/${encodeURIComponent(user.username)}/${user._id}`);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white to-blue-50 p-6">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-md p-8">
        <h2 className="text-2xl font-bold mb-2">Clinic Admin Login</h2>
        <p className="text-sm text-gray-500 mb-6">Sign in to manage leads and sales</p>
