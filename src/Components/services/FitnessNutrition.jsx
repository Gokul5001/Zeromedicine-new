...
import { Dumbbell, Salad, MoveRight } from "lucide-react";
...
const FitnessNutrition = ({ scrollToAppointment }) => {
  ...
  const handleBookConsultation = () => {
    if (window.location.pathname !== "/") {
      ...
      setTimeout(() => {
        scrollToAppointment(); // scroll after page renders
      }, 100);
    } else {
      ...
      <div className="container mx-auto text-center relative z-10 max-w-5xl">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto mb-12">
            Achieve sustainable weight loss, muscle gain, and high-performance
            living through scientifically backed fitness and habit-based nutrition
        ...
        >
          <h3 className="text-2xl font-semibold text-gray-800 mb-6 flex justify-center items-center gap-2">
            <Salad className="w-6 h-6 text-green-500" /> Programs We Offer
          </h3>
