...
import { HeartPulse, Stethoscope, MoveRight } from "lucide-react";
...
const LifestyleDiseases = ({ scrollToAppointment }) => {
  ...
  const handleBookConsultation = () => {
    if (window.location.pathname !== "/") {
      ...
      setTimeout(() => {
        scrollToAppointment(); // scroll after render
      }, 100);
    } else {
      ...
      <div className="container mx-auto text-center relative z-10 max-w-5xl">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto mb-12">
            Our experts specialize in reversing chronic lifestyle disorders through a
            holistic approach involving personalized nutrition, movement, and sleep
            optimization — backed by science and real-world success.
          </p>
        </motion.div>
        ...
        >
          <h3 className="text-2xl font-semibold text-gray-800 mb-6 flex justify-center items-center gap-2">
            <Stethoscope className="w-6 h-6 text-blue-500" /> Conditions We Treat
          </h3>
