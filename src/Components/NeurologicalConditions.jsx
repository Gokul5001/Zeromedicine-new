...
import neuroHero from "../public/Gemini_Generated_Image_Neuro.webp";
...
const NeurologicalConditions = () => {
  ...
  return (
    <main className="overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-700 mb-8 max-w-xl">
              Neurological conditions affect movement, balance, coordination,
              and independence. Our evidence-based neuro-rehabilitation programs
          ...
          <motion.img
            ...
            src={neuroHero}
            alt="Neurological Rehabilitation Physiotherapy"
      ...
      {/* ================= CAUSES ================= */}
      <Section>
        <SectionTitle title="Why Neurological Conditions Occur" />

        <div className="grid md:grid-cols-3 gap-8">
          <CauseCard
            title="Brain Injury or Stroke"
            desc="Reduced blood supply or trauma affects movement and coordination."
          />
          <CauseCard
            title="Spinal Cord & Nerve Damage"
            desc="Compression or injury disrupts nerve signals to muscles."
          />
          <CauseCard
            title="Degenerative Disorders"
            desc="Progressive neurological diseases impact strength and balance."
          />
        </div>
      </Section>
      ...
      {/* ================= CONDITIONS ================= */}
      <Section bg="white">
        <SectionTitle title="Neurological Conditions We Treat" />
          ...
          {[
            ...
            <div key={item} className="card">
              ...
              <p className="text-gray-600">
                Goal-oriented rehabilitation tailored to neurological recovery.
              </p>
            </div>
          ))}
        </div>
      ...
      {/* ================= PROCESS ================= */}
      <Section bg="gradient">
        <SectionTitle title="Our Neuro-Rehabilitation Approach" center />

        <div className="grid md:grid-cols-4 gap-8 text-center">
          <Step number="1" title="Comprehensive Neuro Assessment" />
          <Step number="2" title="Functional Movement Re-training" />
          <Step number="3" title="Balance, Gait & Strength Rehab" />
          <Step number="4" title="Independence & Quality-of-Life Goals" />
        </div>
      </Section>
      ...
      <Section bg="white">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl">
          {[
            "Evidence-based neurological rehab",
            "Focus on independence & daily function",
            "Neuroplasticity-driven training",
            "Long-term progressive programs",
      ...
      <section className="py-24 text-center bg-white">
        <h2 className="text-4xl font-bold mb-6">
          Regain Independence. Rebuild Confidence.
        </h2>
        <p className="text-gray-700 mb-10">
          Specialized neurological rehabilitation designed for long-term recovery.
        </p>
